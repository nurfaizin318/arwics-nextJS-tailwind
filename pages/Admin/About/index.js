                        ...
                        <div className="grid xs:grid-cols-1 lg:grid-cols-3 bg-blue-50 rounded-md">
                            <div className="w-full  ">
                                <div className="w-full h-full  rounded-lg flex justify-center items-center ">
                                    <div className="5/6 h-52 bg-gray-300 flex justify-center items-center rounded-md p-3">
                                        <span className="text-gray-50">Foto All teams</span>
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-32 w-32" fill="none" viewBox="0 0 24 24" stroke="white">
