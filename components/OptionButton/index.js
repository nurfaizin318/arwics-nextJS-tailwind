...
const OptionButton = (props) => {
    ...
    const { onEditing, setOnEditing, index, indexEdit, cancleEdit, editabled, onDelete,indexDelete,deleteStatus } = props;
    ...
    return (
        <div className="h-10 w-full px-1  flex items-center ">
            ...
            {deleteStatus && indexDelete == index  ?
            
            <button disabled className="h-8 w-8 bg-gray-600 rounded-full flex justify-center items-center m-1" onClick={onDelete} >
